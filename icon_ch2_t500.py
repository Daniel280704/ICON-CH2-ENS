...
LATITUDE, LONGITUDE, FILE_LAST_HOUR = 45.07, 7.54, "ultima_ora_icon_ch2_t500.txt"
TARGET_HPA = 500
...
def invia_album(file_paths, caption):
    t, c, th = os.getenv("TELEGRAM_TOKEN"), os.getenv("TELEGRAM_CHAT_ID"), os.getenv("TELEGRAM_THREAD_ID_54")
...
def raggruppa(dt_run):
    b = {}
    # Sfrutto la logica 3-oraria: raggruppa per singola giornata 

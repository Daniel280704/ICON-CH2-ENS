...
def genera_album_cin_ml(dt_run_utc: datetime, nome_run: str):
    ...
    for block_name, ore_list in blocchi.items():
        print(f"\n📊 Generazione album CIN_ML: {block_name}")
        ...
        if percorsi_foto:
            caption_album = f"ICON-CH2 EPS: CIN_ML (Inibizione Connettiva Mixed Layer)\n{block_name}\nRun {nome_run}"
